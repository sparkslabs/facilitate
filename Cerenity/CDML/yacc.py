...
#
# $Header: /home/cvs/cvsroot/projects/cerenity/cgi/Wiki/CDML/yacc.py,v 1.1 2006/12/06 22:00:09 Michael Exp $
#
...
def yacc(method=default_lr, debug=yaccdebug, module=None, tabmodule=tab_module, start=None, check_recursion=1, optimize=0,write_tables=1,debugfile=debug_file):
    ...
    if module:
        ...
        elif isinstance(module, types.InstanceType) or isinstance(module, object):
