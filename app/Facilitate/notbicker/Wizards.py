...
def page_render_html(json, **argd):
    ...
    if action == "overview":
        ...
        return R.render_page(content="New (Composite) Mission Wizard")
    ...
    if action == "edit_new_simplemission":


        number_of_steps = int(argd.get("steps", 5))

        entry_forms = Template ( file = "templates/SimpleMission.Iterated.tmpl",
                                 searchList = [
                                     argd["__environ__"],
                                     {
                                       "entries":range(1,number_of_steps+1),
                                     }
                                 ]
                               )

        content = Template ( file = "templates/SimpleMissionAuthorTest.tmpl",
                                 searchList = [
                                     argd["__environ__"],
                                     {
        ...
        return R.render_page(content=str(content ))
